...

{
  language_tab <- matrix(c(
    ...
    "BAB","WARNINGS / DISCLAIMER",
      "VARNINGAR",
    "BAC","You should not use this model to make management decisions on your farm.",
      "Du bör inte använda den här modellen för att fatta ledningsbeslut på din gård.",
    "BAD","It's purpose is to help explore the factors that drive successful harvest and storage strategies.",
      "Syftet är att hjälpa till att utforska de faktorer som driver framgångsrika skörde- och lagringsstrategier.",
    "BAE","The model is general and may not be suitable to apply to your own production system.",
      "Modellen är generell och kanske inte lämplig för ditt eget produktionssystem.",
    "BAF","This model is not able to reflect that variability in the production system that occur from day to day in reality.",
      "Denna modell kan inte återspegla den variation i produktionssystemet som uppstår från dag till dag i verkligheten.",
    "BAG","It similarly is not able to reflect your willingness to accept these production risks.",
      "På samma sätt kan den inte återspegla din vilja att acceptera dessa produktionsrisker.",
    "BAH","The 2021 price model for Sweden is applied. Prices are assumed fixed in SEK.",
      "Prismodellen 2021 för Sverige tillämpas. Priserna antas fasta i SEK.",
    "BAI","INSTRUCTIONS",
      "INSTRUKTIONER",
    "BAJ","Basically, just work through the tabs.",
      "Det är bara att går igneom flikarna",
    "BAK","The default values set are those that approximately reflect the industry averages.",
      "Standardvärdena är de som ungefär återspeglar branschens genomsnitt.",
    "BAL","If you are unsure what is an appropriate value, either take the default, or set the value to an extreme value and see what happens.",
      "Om du är osäker på vad som är ett lämpligt värde, antingen ta standard, eller ställ in värdet till ett extremt värde och se vad som händer.",
    "BAM","While a model can give an indication for what might happen, one of the best uses for them is think about all the things that the model doesn't capture.",
      "Även om en modell kan ge en indikation på vad som kan hända, är en av de bästa användningsområdena för dem att tänka på alla saker som modellen inte fångar.",
    "BAN","Similarly, when you can see the modelled outcome is different to the actual outcome, this is the time to ask 'why?' and hopefully find some real insight.",
      "På samma sätt, när du kan se att det modellerade resultatet skiljer sig från det faktiska resultatet, är det här dags att fråga 'varför?' och förhoppningsvis hitta någon verklig insikt.",
    "BAO","Please note that the cost information in the Delivery tab is not well developed.",
      "Observera att kostnadsinformationen på fliken Leverans inte är väl utvecklad.",
    "BAP","DEFINITIONS",
      "",
    "BAQ","Clean (mass): The beet mass that is deemed processible.", 
      "",
    "BAR","The term on which root yield is commonly defined.", 
      "",
    "BAS","The mass is independent of sugar concentration.",
      "",
    "BAT","Equals the weight of delivered beet x (1 - dirt-tare).",
      "",
    "BAU","Clean (prices): The price per tonne of clean beet mass, are adjusted to be for a pol of 17%.",
      "",
    "BAV","The term on which prices are set.",
      "",
    "BAW","The price is adjusted 9% per percentage point change in pol from the base of 17%.",
      "",
    "BAX","The conversion to 17% is linear in the change in price per change in pol percentage point.",
      "",
    "BAY","This means that the increase/ decrease in price is greater at lower sugar concentrations.",
      "",
    "BAZ","The contract price is for a pol of 17%.",
      "",
    "BBA","If your pol is higher than this, then the prices per tonne clean given in this model will be higher than your contract price.",
      "",
    "BBB","Delivered: The mass of beet that falls out of the back of the truck at Örtofta.",
      "",
    "BBC","A large fraction of the mass is soil and unprocessible beet material (dirt tare).",
      "",
    "BBD","Is independent of sugar concentration.",
      "",
    ...
    "CHB","Strength values are used to guess the level of harvest damage that will occur.",
      "Styrka används för att gissa graden av skador vid upptagning.",
    "CHC","Variety Strength is currently a relative value, from 0 (weakest) to 100 (strongest).",
      "Sort stryka är för närvarande ett relativt värde, från 0 (svagast) till 100 (starkast)",
    "CHD","Strength can be defined either on this scale, or by selecting the variety type.",
      "Styrka kan definieras antingen på denna skala eller genom att välja sorttyp.",
    "CHE","Weaker varieties will have greater rates of damage.",
      "Svagare sorter kommer att få större skador.",
    "CHF","Sources: NBR Project 631 / COBRI trials and further literature",
      "Källa: NBR Projekt 631 / COBRI försök och andra källa."
